...
const addNewTransaction = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield transaction_service_1.transactionServices.addNewTransaction(req.body);
...
const getMonthlyTransactions = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c, _d, _e;
    const month = ((_b = req.query) === null || _b === void 0 ? void 0 : _b.month)
        ? parseInt((_c = req.query) === null || _c === void 0 ? void 0 : _c.month)
        : undefined;
    const year = ((_d = req.query) === null || _d === void 0 ? void 0 : _d.year)
        ? parseInt((_e = req.query) === null || _e === void 0 ? void 0 : _e.year)
        : undefined;
    const result = yield transaction_service_1.transactionServices.getMonthlyTransactions(month, year);
    (0, sendResponse_1.default)(res, {
        status: http_status_1.default.OK,
        success: true,
...
const deleteTransactionData = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _f;
    const result = yield transaction_service_1.transactionServices.deleteTransactionData((_f = req.params) === null || _f === void 0 ? void 0 : _f.transactionId);
    (0, sendResponse_1.default)(res, {
        status: http_status_1.default.OK,
        success: true,
